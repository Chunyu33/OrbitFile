...
│  │  • check_link_status       检查链接健康     │               │
│  │  • preview_ghost_links     预览幽灵链接     │               │
...
│   │   └── app_manager/         # 应用管理模块
│   │       ├── mod.rs
│   │       ├── scanner.rs       # 注册表扫描（4 路径：HKLM/HKCU × 普通/WOW6432Node）
│   │       ├── migration.rs     # 迁移引擎
